...
<script>
  ...
  let project1 = {
    ...
    problem_statement: "Students interested in design had no dedicated platform to collaborate and showcase their skills in a hackathon-style environment."
  };
</script>
...
<div class="text-[#000000] bg-[#FFFFFF] min-h-screen p-8">
  ...
  <div id="extras" class="mt-44 m-10">
    ...
    <div class="flex flex-col md:flex-row items-center md:items-start justify-between pt-12">
      ...
      <div class="w-80 h-96 border-2 shadow-lg -rotate-5 flex items-center justify-center">
        <img src={AboutMeImage} alt="About Me Image" class="w-72 h-80 object-cover" />
      </div>
  ...
  <div id="extras" class="mt-44 m-10">
    <p class="text-5xl font-sans">My College Journey</p>
  </div>
