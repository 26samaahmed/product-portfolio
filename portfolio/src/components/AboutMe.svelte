...
<main>
  ...
  <a href="https://samahmed.info" target="_blank" class="text-2xl mt-12 inline-block relative float-right border p-3 rounded hover:bg-[#000000] hover:text-white duration-500">Discover Technical & Creative Portfolios →</a>
</main>