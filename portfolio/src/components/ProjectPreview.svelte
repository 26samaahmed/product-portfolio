...
<main>
  <div class="w-2/3 h-full border-2 shadow-lg mt-6 p-10 m-auto rounded-sm hover:scale-[1.02] duration-500">
    <div class="flex flex-col md:flex-row space-x-4 items-center mb-5">
    ...
    {/each}
      ...
      <a href="/casestudies" target="_blank" 
            class="inline-block border px-5 py-1 bg-[#4696fd] text-lg text-white rounded-full 
                    hover:text-[#4696fd] hover:bg-white duration-500">
            Check Case Study
      </a>
    </div>
    <p class="text-2xl mb-1">Duration: {project_duration}</p>
